...
describe ::Inch::CodeObject::Provider::YARD do
  ...
  it "should parse" do
    provider = described_class.parse(fixture_path(:ruby, :simple))
  ...
  it "should parse too different codebases" do
    ...
    provider1 = described_class.parse(fixture_path(:ruby, :diff1))
    object1 = provider1.objects.find { |o| o.fullname == fullname }

    provider2 = described_class.parse(fixture_path(:ruby, :diff2))
